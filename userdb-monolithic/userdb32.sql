...
CREATE TABLE userdb.users (
  ...
  suspendstart     int4    NULL,
  suspendend       int4    NULL,
  suspendreason    VARCHAR NULL,
  suspenderid      int4    NULL,
  replicationflags int4    NOT NULL,
  created          int4    NOT NULL,
  modified         int4    NOT NULL,
  revision         int4    NOT NULL,
...
CREATE TABLE userdb.maildomainconfigs (
  ...
  maxlocal         int4    NOT NULL,
  maxdomain        int4    NOT NULL,
  replicationflags int4    NOT NULL,
  created          int4    NOT NULL,
  modified         int4    NOT NULL,
  revision         int4    NOT NULL,
...
CREATE OR REPLACE FUNCTION userdb.addlanguage(int4,varchar,varchar,int4,int4,int4,int4,int8) RETURNS void AS '
...
CREATE OR REPLACE FUNCTION userdb.modifylanguage(int4,varchar,varchar,int4,int4,int4,int4,int8) RETURNS void AS '
...
CREATE OR REPLACE FUNCTION userdb.deletelanguage(int4) RETURNS void AS '
  DELETE FROM userdb.languages WHERE languageid = $1;
' LANGUAGE SQL;

CREATE OR REPLACE FUNCTION userdb.adduser(int4,varchar,bytea,int4,varchar,varchar,int4,int4,int4,int4,int4,int4,varchar,int4,int4,int4,int4,int4,int8) RETURNS void AS '
...
CREATE OR REPLACE FUNCTION userdb.modifyuser(int4,varchar,bytea,int4,varchar,varchar,int4,int4,int4,int4,int4,int4,varchar,int4,int4,int4,int4,int4,int8) RETURNS void AS '
...
CREATE OR REPLACE FUNCTION userdb.deleteuser(int4) RETURNS void AS '
  DELETE FROM userdb.users WHERE userid = $1;
...
CREATE OR REPLACE FUNCTION userdb.addusertagdata(int4,int4,bytea) RETURNS void AS '
  INSERT INTO userdb.usertagsdata (tagid,userid,tagdata) VALUES ($1,$2,$3);
' LANGUAGE SQL;

CREATE OR REPLACE FUNCTION userdb.modifyusertagdata(int4,int4,bytea) RETURNS void AS '
  UPDATE userdb.usertagsdata SET tagdata = $3 WHERE tagid = $1 AND userid = $2;
' LANGUAGE SQL;

CREATE OR REPLACE FUNCTION userdb.deleteusertagdata(int4,int4) RETURNS void AS '
...
CREATE OR REPLACE FUNCTION userdb.deleteallusertagdatabyuserid(int4) RETURNS void AS '
  DELETE FROM userdb.usertagsdata WHERE userid = $1;
' LANGUAGE SQL;

CREATE OR REPLACE FUNCTION userdb.addmaildomainconfig(int4,varchar,int4,int4,int4,int4,int4,int4,int4,int8) RETURNS void AS '
...
CREATE OR REPLACE FUNCTION userdb.modifymaildomainconfig(int4,varchar,int4,int4,int4,int4,int4,int4,int4,int8) RETURNS void AS '
...
CREATE OR REPLACE FUNCTION userdb.deletemaildomainconfig(int4) RETURNS void AS '
